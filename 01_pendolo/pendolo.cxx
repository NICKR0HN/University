...
int main(){
    PrintEndofFile();
    sample_struct sample_1a = FileAnalysis("./Data/campione1a.txt");
    sample_struct sample_1b = FileAnalysis("./Data/campione1b.txt");
    sample_struct sample_1ab_normdev = FileAnalysis("./Data/campione1ab.txt", true);
    sample_struct sample_1c = FileAnalysis("./Data/campione1c.txt");
    sample_struct sample_4a = FileAnalysis("./Data/campione4a.txt");
    sample_struct sample_4b = FileAnalysis("./Data/campione4b.txt");
    sample_struct sample_4c = FileAnalysis("./Data/campione4c.txt");
    sample_struct sample_4ab_normdev = FileAnalysis("./Data/campione4ab.txt", true);
    return 0;
}
